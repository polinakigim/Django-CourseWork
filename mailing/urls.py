...
from mailing.views import (BlockMailingView, HomeView, MailingAttemptListView,
                           ...
                           RecipientUpdateView, SendMailingView)
...
urlpatterns = [
    ...
    path('mailing_block/<int:mailing_id>/', BlockMailingView.as_view(), name='mailing_block'),
